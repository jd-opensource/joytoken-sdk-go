...
func TestRunLoopsReturnPartialResultOnContinuationError(t *testing.T) {
	t.Run("chat", func(t *testing.T) {
		...
		if err == nil || result == nil || len(result.Steps) != 1 || len(result.Steps[0].ToolResults) != 1 || len(result.Messages) != 3 {
	...
	t.Run("responses", func(t *testing.T) {
		...
		if err == nil || result == nil || len(result.Steps) != 1 || len(result.Steps[0].ToolResults) != 1 || len(result.Input) != 3 {
